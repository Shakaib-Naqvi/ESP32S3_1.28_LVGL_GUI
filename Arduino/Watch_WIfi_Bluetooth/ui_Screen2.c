...
void ui_event_Screen2(lv_event_t * e)
{
    ...
    if(event_code == LV_EVENT_GESTURE &&  lv_indev_get_gesture_dir(lv_indev_get_act()) == LV_DIR_LEFT) {
        ...
        _ui_screen_change(&ui_Screen1, LV_SCR_LOAD_ANIM_MOVE_LEFT, 350, 0, &ui_Screen1_screen_init);
    }
}
...
void ui_Screen2_screen_init(void)
{
    ...
    lv_img_set_src(ui_Image4, &ui_img_settings_24dp_e3e3e3_fill0_wght400_grad0_opsz24_png);
